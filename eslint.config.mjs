...
const noDirectSupabaseWriteSelectors = [
  {
    selector:
      "CallExpression[callee.property.name=/^(insert|update|upsert|delete)$/][callee.object.callee.property.name='from'][callee.object.arguments.0.type='Literal'][callee.object.arguments.0.value=/^(goals|goal_links|goal_shares|goal_participants|profiles|notification_schedules)$/]",
    message:
