...
function createRequest() {
  return new Request("http://localhost/api/planner/items/lock", {
    method: "POST",
...
describe("planner item lock route", () => {
  beforeEach(() => {
  ...
  it("returns updated lock state and digest", async () => {
    ...
    expect(mocks.rpc).toHaveBeenCalledWith("set_planner_item_lock", {
  ...
  it("maps unknown planner item ids to planner_item_not_found", async () => {
    mocks.rpc.mockResolvedValue({
      data: null,
