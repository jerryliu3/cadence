    ...
    >
      <ul
        className={cn(
          "grid w-full gap-1",
          mobile
            ? `${gridClass} max-w-[22.5rem] rounded-[1.35rem] border border-border/20 bg-background/10 p-1.5 shadow-sm shadow-black/5 backdrop-blur-md supports-[backdrop-filter]:bg-background/10`
            : gridClass
        )}
      >
