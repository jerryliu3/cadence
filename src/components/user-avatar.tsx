...
export function UserAvatar({
  ...
  return (
    <button
      type="button"
      className="cursor-pointer rounded-full p-0.5 transition-colors hover:bg-muted/50 active:bg-muted/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
