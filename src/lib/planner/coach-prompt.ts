...
export function buildCoachPrompt({
  ...
  return [
    ...
    "- For actionable needs_goal requests, include goalDraftPrompt as plain instructions for 1-5 recurring cadence goals with absolute YYYY-MM-DD start/end dates and target counts when known.",
    "- Never create one goal per workout, session, or date. Consolidate repeated sessions into cadence goals such as easy run weekly or strength training twice per week.",
