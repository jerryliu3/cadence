...
export function buildCoachPrompt({
  ...
  return [
    ...
    "- For fixed_milestones, describe the session pattern and progression structure clearly (session types, horizon, ordering) so the downstream parser can expand milestone_names.",
    "- Do not list every single session line unless it is necessary for correctness.",
