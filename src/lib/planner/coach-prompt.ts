...
export function buildCoachPrompt({
  ...
  return [
    ...
    "The calendar compiler can move existing sessions across months when sessionMoves include a matching goalId and unitKey. It still cannot create goals or invent new unit keys.",
