...
describe("buildDirectDraftPersistence", () => {
  ...
  it("keeps persisted manual items in direct draft saves", () => {
    const result = buildDirectDraftPersistence({
      snapshot: {
        ...snapshot,
        activePlan: {
          ...
          items: [
            ...snapshot.activePlan!.items,
            {
              ...
              requirement_kind: "milestone_sequence",
              ...
              scheduled_time_override: "07:45",
              effective_scheduled_local_time: "07:45",
            },
          ],
        },
      },
    ...
    expect(
      result.find((item) =>
        item.unit_key === "manual:11111111-1111-4111-8111-111111111111"
      )
    ).toMatchObject({
      goal_id: goal.id,
      scheduled_date: "2026-08-15",
