-- Additive Phase 27:
-- Consolidate publish RPC behavior into a single overload and remove
-- eligibility-mode trigger indirection.

drop trigger if exists execution_plan_publish_eligibility_mode_override
on public.execution_plans;

drop function if exists private.apply_publish_eligibility_mode_override();
