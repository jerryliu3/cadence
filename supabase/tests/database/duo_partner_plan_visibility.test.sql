...
select is(
  (
    ...
    from public.get_duo_partner_plan_service(date '2026-08-01')
  ),
  1,
...
select ok(
  (
    select exists(
      select 1
      from public.get_duo_partner_plan_service(date '2026-08-01') item
...
where duo_id = '9f300000-0000-4000-8000-000000000001'
...
select is(
  (
    select count(*)::integer
    from public.get_duo_partner_plan_service(date '2026-09-01')
  ),
  0,
